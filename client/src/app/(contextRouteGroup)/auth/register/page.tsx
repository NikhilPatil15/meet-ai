...
<div
      className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-black-200 mt-6" >
      ...
      <form className="my-8" onSubmit={handleSubmit}>
        ...
        <LabelInputContainer className="mb-4">
          <Label htmlFor="username" className="  text-sky-200">
            Username {"    "}
            <FontAwesomeIcon
              icon={faCheck}
        ...
        <LabelInputContainer className="mb-4">
          <Label htmlFor="email" className="  text-sky-200">Email Address</Label>
          <Input
            id="email"
            autoComplete="off"
            value={email}
        ...
        <div className="flex flex-col space-y-4">
          <button
            className=" relative group/btn flex space-x-2 items-center justify-start px-4 w-full text-black rounded-md h-10 font-medium shadow-input bg-white-100 dark:bg-zinc-900 dark:shadow-[0px_0px_1px_1px_var(--neutral-800)]"
            type="submit"
          >
